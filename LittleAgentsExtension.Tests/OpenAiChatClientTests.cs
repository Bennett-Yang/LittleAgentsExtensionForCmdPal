...
public sealed class OpenAiChatClientTests
{
    ...
    internal sealed class FakeHttpHandler : HttpMessageHandler
    {
        ...
        public static FakeHttpHandler SseChunks(int chunkCount) => new(async (request, cancellationToken) =>
        {
            string body = CreateSseBody(chunkCount) + "data: [DONE]\n\n";
            return CreateSseResponse(new MemoryStream(Encoding.UTF8.GetBytes(body)));
        });
